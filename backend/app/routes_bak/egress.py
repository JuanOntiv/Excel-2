...
from app.models.egress import Egress, EgressCreate, EgressUpdate, EgressRead
...
@router.post("/", response_model=EgressRead, status_code=201)
@log_action(action="CREATE", entity="Egress", level="INFO")
def create_egress(
    egress_in: EgressCreate,
